...
$count = Question:: getQuestionsCount (ACTION, 1)['questions_count']+Question:: getQuestionsCount (ACTION, 2)['questions_count']+Question:: getQuestionsCount (ACTION, 3)['questions_count'];
