...
if ($_SESSION['action'] == 6){
    $title = "Пройдите 30 вопросов и получите скидку более миллиона рублей на квартиру в новостройке у метро \"Селигерская\"";
    $prize = "Ту самую скидку более миллиона рублей на квартиру в новостройке у метро \"Селигерская\"";
}
if ($_SESSION['action'] == 5){
    $title = "Пройдите 30 вопросов и получите скидку более миллиона рублей на квартиру в ЖК \"Любовь и голуби\"";
