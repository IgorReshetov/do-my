...
<div class="main">
    ...
    <!-- 'это будущий блок проверки на бота. в него я передаю три переменные количество цветов, домиков и лисов на планете. Задача Юры нарисовать их разного размера и с разным поворотом вокруг планеты и все это сделать на стороне сервера' -->
    <div class="antebot"></div> 
