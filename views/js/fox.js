...
var fox = {
    ...
    words: {
        ...
        about_level: ["В тесте 3 уровня по 7 вопросов.<br>Для ответа выбери вариант<br>и жми на кнопку ответь", "Знание-сила!<br>В финале теста<br>тебя ждет два подарка", "Отлично!<br>Осталось 7 вопросов.<br>Финиш близко!"],
