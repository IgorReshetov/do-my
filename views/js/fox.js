...
var fox = {
    ...
    words: {
        ...
        about_level: ["В тетсе 3 уровня по 7 вопросов.<br>Для ответа выбери вариант<br>и жми на кнопку ответь", "Знание-сила!<br>В финале 3 уровня<br>тебя ждет два подарка", "Отлично!<br>Осталось 7 вопросов.<br>Финиш близко!"],
