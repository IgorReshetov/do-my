...
function fill_circle() {
    ...
    if (mobile == 0) S(C('step-survey-finish')[0]).left = (countQst*47 + 10) + 'px';
    else S(C('step-survey-finish')[0]).left = (countQst*29 + 10) + 'px';
}
...
function resize_step() { 
    ...
    if (mobile == 0) {
        ...
        S(C('step-survey-finish')[0]).left = (countQst*47 + 10) + 'px';
        ...
        S(C('step-survey-finish')[0]).left = (countQst*29 + 10) + 'px';
    }
}
