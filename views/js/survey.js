...
function init() {
    ...
    if (button1 != null){
        ...
        setTimeout(function(){
            ...
            setTimeout(function(){
                var el = C("land-block-text land-block1-text")[0];
                console.log(el.getBoundingClientRect().top);
                handl_scroll_el = setInterval(scroll_to_element,15,el);
            },3000);
            setTimeout(function(){
                var el = C("land-block-text land-block2-text")[0];
                console.log(el.getBoundingClientRect().top);
                handl_scroll_el = setInterval(scroll_to_element,15,el);
            },6000);
            setTimeout(function(){
                var el = C("land-block-text land-block3-text")[0];
                console.log(el.getBoundingClientRect().top);
                handl_scroll_el = setInterval(scroll_to_element,15,el);
            },8000);
            setTimeout(function(){
                var el = C("land-block-text land-block4-text")[0];
                console.log(el.getBoundingClientRect().top);
                handl_scroll_el = setInterval(scroll_to_element,15,el);
            },10000);
            setTimeout(function(){
                var el = C("land-block-text land-block5-button land-block5-button-scroll")[0];
                console.log(el.getBoundingClientRect().top);
                handl_scroll_el = setInterval(scroll_to_element,15,el);
            },12000);
