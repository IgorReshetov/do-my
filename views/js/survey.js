...
function fill_circle() {
    ...
    if (mobile == 0) S(C('step-survey-finish')[0]).left = (countQst*47) + 'px';
    else S(C('step-survey-finish')[0]).left = (countQst*29) + 'px';
}
...
function resize_step() { 
    ...
    if (mobile == 0) {
        ...
        S(C('step-survey-finish')[0]).left = (countQst*47) + 'px';
        ...
        S(C('step-survey-finish')[0]).left = (countQst*29) + 'px';
    }
}
